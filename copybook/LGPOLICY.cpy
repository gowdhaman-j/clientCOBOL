      ...
      * ... IS THE DCLGEN COMMAND THAT MADE THE FOLLOWING STATEMENTS   *
      ******************************************************************
           EXEC SQL DECLARE GENASA1.CUSTOMER TABLE
           ( CUSTOMERNUMBER                 INTEGER NOT NULL,
             FIRSTNAME                      CHAR(10),
             LASTNAME                       CHAR(20),
             DATEOFBIRTH                    DATE,
           ...
           EXEC SQL DECLARE GENASA1.CLAIM TABLE
      ...
      * ... IS THE DCLGEN COMMAND THAT MADE THE FOLLOWING STATEMENTS   *
      ******************************************************************
           EXEC SQL DECLARE GENASA1.COMMERCIAL TABLE
           ( POLICYNUMBER                   INTEGER NOT NULL,
      ...
      * ... IS THE DCLGEN COMMAND THAT MADE THE FOLLOWING STATEMENTS   *
      ******************************************************************
           EXEC SQL DECLARE GENASA1.ENDOWMENT TABLE
           ( POLICYNUMBER                   INTEGER NOT NULL,
             EQUITIES                       CHAR(1),
             WITHPROFITS                    CHAR(1),
             MANAGEDFUND                    CHAR(1),
      ...
      * ... IS THE DCLGEN COMMAND THAT MADE THE FOLLOWING STATEMENTS   *
      ******************************************************************
           EXEC SQL DECLARE GENASA1.CUSTOMER_SECURE TABLE
           ( CUSTOMERNUMBER                 INTEGER NOT NULL,
           ...
           EXEC SQL DECLARE GENASA1.HOUSE TABLE
           ( POLICYNUMBER                   INTEGER NOT NULL,
           ...
           EXEC SQL DECLARE GENASA1.MOTOR TABLE
           ( POLICYNUMBER                   INTEGER NOT NULL,
             MAKE                           CHAR(15),
             MODEL                          CHAR(15),
             VALUE                          INTEGER,
